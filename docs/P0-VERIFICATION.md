...
env -u NODE_ENV npm --prefix vendor/pi-web-ui exec vitest run   # 635 passed / 77 files
...
npm run test:channels:browser     # Chromium（桌面 + 移动视口）：选择器/设置页/账户状态/用量归属/逐请求记录/用量历史/系统资源 29 项断言
```
