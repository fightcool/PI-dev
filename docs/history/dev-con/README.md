...
<!-- 🍞 AI Breadcrumb — @COUPLED ../../DEV-CON-PROPOSAL.md, assessment.md, architecture-v1.2.md, readonly-prototype.md -->

**本目录全部为历史材料，不定义当前需求、实施顺序或部署授权。当前唯一开发基准为 [DEV-CON-PROPOSAL.md](../../DEV-CON-PROPOSAL.md)。**
...
归档正文中的“当前”“本轮”“已通过”均指当时记录。原型截图在忽略目录中，仅本地生成后存在；历史测试数字不能替代新实现验证。本文档整理不执行归档命令、不修改真实配置、不提交或部署代码。
