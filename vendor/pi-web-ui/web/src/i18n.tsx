...
export const zh = {
	...
	channelAccountKeyQuota: "已用",
	channelAccountRemaining: "剩余",
	...
	channelAccountModeTemplate: "JSON 模板（自己写接口与字段映射）",
	channelAccountKindNone: "不查询",
	channelAccountKindTemplate: "JSON 模板",
	channelAccountKindGateway: "网关探测",
	channelAccountKindOther: "自定义（{kind}）",
