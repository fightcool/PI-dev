...
export const en: EnDictionary = {
	...
	loadCpu: "CPU",
	loadMem: "MEM",
	loadTip: "Machine load (details: Settings → System)",
	...
	gatewayModelsEnabled: "{on} of {total} enabled",
	gatewayModelsToggleHint: "Click a model to toggle it: disabled models are hidden from the model picker (nothing else changes — config and history stay).",
	gatewayModelEnable: "Click to enable (show in the picker again)",
	gatewayModelDisable: "Click to disable (hide from the picker)",
